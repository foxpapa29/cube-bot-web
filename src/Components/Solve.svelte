  ...
  <div class="row">
    <main class="container">
      <div class="pt-3 pb-2 mb-3">
        <h1 class="h1 text-center">Scramble</h1>
      </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-shopping-cart"><circle
                  cx="9"
                  cy="21"
                  r="1" />
                <circle cx="20" cy="21" r="1" />
                <path
                  d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" /></svg>
              Products
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-bar-chart-2"><line
                  x1="18"
                  y1="20"
                  x2="18"
                  y2="10" />
        ...
        <h6
          ...
          <a class="link-secondary" href="#" aria-label="Add a new report">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="feather feather-plus-circle"><circle
                cx="12"
                cy="12"
                r="10" />
